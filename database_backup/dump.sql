...
CREATE TABLE `items` (
  ...
  KEY `idx_items_stock_quantity` (`item_Stock_quantity`),
  KEY `idx_items_category_active` (`item_Category`,`item_Is_active`)
...
(1,'Item 1',NULL,10.00,NULL,0,1,'2025-10-16 15:13:56','2025-10-16 15:13:56'),
(2,'Item 2',NULL,11.00,NULL,0,1,'2025-10-16 15:14:04','2025-10-16 15:14:04'),
(3,'Item 3',NULL,10.00,NULL,0,1,'2025-10-16 15:13:56','2025-10-16 15:13:56'),
(4,'Item 4',NULL,11.00,NULL,0,1,'2025-10-16 15:14:04','2025-10-16 15:14:04');
...
('m251016_161639_update_order_items_table',1760632824),
('m251016_161648_update_items_table',1760632824),
('m251016_161700_update_order_items_foreign_keys',1760632824);
...
CREATE TABLE `order_items` (
  ...
  KEY `idx_order_items_Order_id` (`order_item_Order_id`),
  KEY `idx_order_items_Item_id` (`order_item_Item_id`),
  KEY `idx_order_items_Order_Item` (`order_item_Order_id`,`order_item_Item_id`),
  CONSTRAINT `fk_order_items_Item_id` FOREIGN KEY (`order_item_Item_id`) REFERENCES `items` (`item_Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_order_items_Order_id_new` FOREIGN KEY (`order_item_Order_id`) REFERENCES `order` (`order_Id`) ON DELETE CASCADE ON UPDATE CASCADE
...
(1,1,1,1,12.00,13.00,'2025-10-16 15:19:10','2025-10-16 15:19:10'),
(2,1,2,1,12.00,13.00,'2025-10-16 15:19:10','2025-10-16 15:19:10'),
(3,2,2,1,12.00,13.00,'2025-10-16 15:19:10','2025-10-16 15:19:10');
...
-- Dump completed on 2025-10-18 10:53:18
